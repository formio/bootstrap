...
## [Unreleased: 3.0.2-rc.3]
### Changed
 - Add back "FIO-9761: fixed an issue where fontawesome icons do not appear"

## 3.0.2-rc.2
### Changed
 - Revert "FIO-9761: fixed an issue where fontawesome icons do not appear"
